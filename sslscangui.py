...
class StartApp(tk.Tk):
    def __init__(self):
        ...
        self._frame = None
        photo_exit = PhotoImage(file="images/icona_pri.png")
    ...
    def on_closing(self):
        self.iconbitmap("images/icona_pri.ico")
        photo_exit = PhotoImage(file="images/icona_pri.png")
        self.iconphoto(False, photo_exit)
...
class StartPage(tk.Frame):
    def __init__(self, master, bg="blank"):
        ...
        load = PIL.Image.open("images/icona_pri.png")
...
def analisi_lista_host(self, nome_doc):
    ...
    window.iconbitmap("images/icona_pri.ico")
    load = PIL.Image.open("images/icona_pri.png")
    render = ImageTk.PhotoImage(load)
...
if __name__ == "__main__":
    ...
    app.iconbitmap("images/icona_pri.ico")
    app.mainloop()
